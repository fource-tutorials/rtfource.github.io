...
<div id="nav">
      ...
      <div id="main">
      <center><img src="media/thank.jpg" width="600px height=400px"></center>
      <?php
$fn=$_POST['fname'];
$ln=$_POST['lname'];
$oc=$_POST['occupation'];
...
$sql="insert into doubt values('".$fn."','".$ln."','".$oc."','".$p."',".$cn.",'".$em."','".$com."');";
if(mysql_query($sql))
    echo "<h3>Want to see your response?</h3>";
else
  {
  echo mysql_error();
  echo "<h2 style='color:skyblue'>There's a problem while submitting doubt Please try again</h2>";
  }
?>

  <a href="readingdata.php"><h4 style='color:skyblue'>Click Here</h4></a>    
