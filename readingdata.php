...
$result=mysql_query("select *from doubt");
if(!$result)
{
  echo mysql_error();
  exit();
...
echo "<th>Firstname</th><th>lastname</th><th>School/occupation</th><th>Place</th><th>Contact</th><th>Email</th><th>Comment</th></tr>";
